...
<sub>**notes & sources** — current figures are cited to 2024–2026 data; the historical milestones are, by nature, older. The opinions are mine.</sub>

*Recent (2024–2026):*

- <sub>Scale, pay, and outlook — ~351,100 jobs, $101,140 median wage, 11% projected growth 2024–34 — U.S. Bureau of Labor Statistics, [Occupational Outlook Handbook: Industrial Engineers](https://www.bls.gov/ooh/architecture-and-engineering/industrial-engineers.htm) (2024 data, accessed 2026)</sub>
- <sub>Broader engineering-growth context — [BLS Monthly Labor Review, Jan 2026](https://www.bls.gov/opub/mlr/2026/article/industry-and-occupational-employment-projections-overview.htm) · [Society of Women Engineers, 2025 outlook](https://swe.org/research/2025/us-job-outlook/)</sub>
- <sub>Still misunderstood / kept boxed into manufacturing — [Zion Solutions Group, Nov 2025](https://www.thezsg.com/post/it-takes-more-than-engineers-to-make-industrial-engineering-work) · [KU thesis: utilizing IEs beyond the factory](https://kuscholarworks.ku.edu/entities/publication/aa6a09e4-17d2-4ac0-aff6-e0430788adce)</sub>
- <sub>Roles + industries (manufacturing, healthcare, logistics, finance) — [Research.com, 2026](https://research.com/advice/which-employers-hire-industrial-engineering-degree-graduates-industries-roles-hiring-patterns) · the title means very different things at different companies — [SCMTalent](https://scmtalent.com/industrial-engineer-job-description)</sub>
- <sub>Definition + "any industry" range — [IISE](https://www.iise.org/details.aspx?id=282) · [Purdue IE](https://engineering.purdue.edu/IE/academics/undergraduate/what-is-ie)</sub>

*Historical milestones (necessarily older):*

- <sub>Taylor, time study (1881), the stopwatch and the "one best way" — [Britannica: Frederick W. Taylor](https://www.britannica.com/biography/Frederick-W-Taylor); the Gilbreths and motion study — [MasterClass: Taylorism](https://www.masterclass.com/articles/understanding-taylorism-the-history-of-scientific-management-theory)</sub>
- <sub>Operations research born in WWII (radar, convoys, resource allocation) — [The OR Society](https://www.theorsociety.com/ORS/ORS/About-OR/The-history-of-OR.aspx)</sub>
- <sub>Lean from the Toyota Production System (1950s) and Six Sigma from Motorola (1987) — [history of Lean Six Sigma](https://www.learnleansigma.com/lss-yellow-belt-course/history-of-lean-six-sigma/)</sub>
